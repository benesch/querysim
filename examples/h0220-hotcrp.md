...
select Paper.*,
       ...
       PaperReview.interestToCommunity as interestToCommunity,
       PaperReview.likelyPresentation as likelyPresentation,
       ...
       PaperReview.textField8 as textField8,
...
order by Paper.paperId,
         PaperReview.reviewOrdinal
```
[examples/h0220-hotcrp.md](/examples/h0220-hotcrp.md)